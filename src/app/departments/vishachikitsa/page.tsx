...
export default function Page() {
  return (
    <>
      <PageHeroSection
        title="Vishachikitsa Department"
        subtitle="Expert Ayurvedic care from qualified specialists at SVKM's Krutiben Bhupeshbhai Patel Ayurveda Hospital."
        breadcrumb={[{ label: "Hospital", href: "/hospital/doctors" }, { label: "Departments", href: "/hospital/doctors" }, { label: "Vishachikitsa", href: "/departments/vishachikitsa" }]}
      />
      <section className="py-16 px-4" style={{ background: "var(--ayu-cream)" }}>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-600 mb-6">Detailed information for Vishachikitsa Department is being updated. Please contact us for doctor schedules and appointments.</p>
