  ...
  return (
    <>
      <PageHeroSection
        ...
        breadcrumb={[{ label: "Hospital", href: "/hospital/doctors" }, { label: "Services", href: "/hospital/services/opd" }, { label: "Pathology", href: "/hospital/services/pathology" }]}
      />
      <section className="py-16 px-4" style={{ background: "var(--ayu-cream)" }}>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-600 mb-6">Detailed information about Pathology services is being updated. Please contact us directly for enquiries.</p>
